...
- Prepared statements with automatic buffer management and truncation refetch
- Connection utilities: ping, reset, change_user, select_db, reset_connection
...
Requires libmariadb (MariaDB Connector/C) and EV.

```
apt install libmariadb-dev    # Debian/Ubuntu
brew install mariadb-connector-c   # macOS
